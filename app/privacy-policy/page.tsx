  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            browsing history on that website.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            refers to Metatech, accessible from https://metatech.dev
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>To manage Your Account and User</strong>
            information.
          </p>
        </li>
        <li>
          <p>
            <strong>For the performance of a contract</strong>, including to
            prepare, send or arrange forelivery of goods or services.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>For other purposes</strong>, including data analysis,
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            We may share Your information with Our affiliates to process
            payments and generate income.
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        require Your parent&apos;s consent before We collect and use Personal
        Data.
      </p>
      ...
      <ul>
        <li>
          By email: <a href="mailto:5vLl0@example.com">5vLl0@example.com</a>
        </li>
      </ul>
    </div>
  );
